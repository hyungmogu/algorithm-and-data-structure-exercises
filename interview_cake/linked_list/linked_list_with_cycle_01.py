...
# Solution (using two pointers - fast pointer and slow pointer)
# #
# first_pointer = node
# second_pointer = node

# # 1. while not second_pointer.next == first_pointer:
...
# return True
 ...
 # 1. while not second_pointer.next == first_pointer:
# 2. increment second pointer by 2 elements
# 3. increment first_pointer by 1 element
# 4. if index out of range, return false
